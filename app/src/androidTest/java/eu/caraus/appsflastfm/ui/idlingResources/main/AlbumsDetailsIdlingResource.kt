...
class AlbumsDetailsIdlingResource  : IdlingResource {
    ...
    override fun isIdleNow(): Boolean {
        ...
        val fragment = activity?.supportFragmentManager?.findFragmentById( R.id.main_fragment_container ) as BaseFragment?
